...
class ePIC_DVCS_TASK{
 private:
  ...
  Float_t fMax_pTmiss{};   // Maximum missing transverse momentum (both full and semi final state)
 ...
 public:
  ...
  void setMax_pTmiss(Float_t cut){ fMax_pTmiss = cut; }
  ...
  Double_t calcTrentoPhi_qg(P3EVector k, P3EVector p, P3EVector kprime, P3EVector gprime);
