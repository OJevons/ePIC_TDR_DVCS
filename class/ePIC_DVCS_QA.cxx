...
void ePIC_DVCS_TASK::doAnalysis(){
  ...
  // Q2
  TH1D* h_Q2_Truth = new TH1D("q2_truth",";Q^{2}(MC) [(GeV/#it{c}^{2})^{2}]"      , 100, 0., 10.);
  TH1D* h_Q2_Acc   = new TH1D("q2_acc"  ,";Q^{2}(MC|Reco.) [(GeV/#it{c}^{2})^{2}]", 100, 0., 10.);
  TH1D* h_Q2_Reco  = new TH1D("q2_reco" ,";Q^{2}(Reco.) [(GeV/#it{c}^{2})^{2}]"   , 100, 0., 10.);
  TH2D* h_Q2_Resp  = new TH2D("q2_resp" ,";Q^{2}(MC|Reco.) [(GeV/#it{c}^{2})^{2}];Q^{2}(Reco.) [(GeV/#it{c}^{2})^{2}]", 100, 0., 10., 100, 0., 10.);
  TH1D* h_Q2_Pur   = new TH1D("q2_pur"  ,";Q^{2}(Reco.) [(GeV/#it{c}^{2})^{2}];#frac{MC|Reco.}{Reco.}", 100, 0., 10.);
  TH1D* h_Q2_Mig   = new TH1D("q2_mig"  ,";Q^{2}(Reco.) [(GeV/#it{c}^{2})^{2}];#frac{MC#pm1|Reco.}{Reco.}", 100, 0., 10.);
  TH2D* h_dQ2vQ2   = new TH2D("dq2vq2"  ,";Q^{2}(MC|Reco.) [(GeV/#it{c}^{2})^{2}];#DeltaQ^{2} [(GeV/#it{c}^{2})^{2}]", 100, 0., 10., 200, -10., 10.);
  // x
  ...
  TH2D* h_dxBvxB   = new TH2D("dxbvxb"  ,";x_{B}(MC|Reco.);#Deltax_{B}",1e4, 0., 1., 200, -1., 1.);
  // y
  ...
  TH2D* h_dyvy    = new TH2D("dyvy"   ,";y(MC|Reco.);#Deltay",100, 0., 1., 200, -1., 1.);
  ...
  TH2D* h_B0dtvt   = new TH2D("b0dtvt"  ,";|t|(MC|Reco. - B0) [(GeV/#it{c}^{2})^{2}];#Deltat [(GeV/#it{c}^{2})^{2}]", 40, 0., 2., 40, -1., 1.);
  TH2D* h_RPdtvt   = new TH2D("rpdtvt"  ,";|t|(MC|Reco. - RP) [(GeV/#it{c}^{2})^{2}];#Deltat [(GeV/#it{c}^{2})^{2}]", 40, 0., 2., 40, -1., 1.);
  // t from eX method - All e'gamma events
  TH1D* h_teXBEAll_Truth   = new TH1D("texbeall_truth"  ,";|t|_{eXBE}(MC) [(GeV/#it{c}^{2})^{2}]"      , 40, 0., 2.);
  TH1D* h_teXBEAll_Acc     = new TH1D("texbeall_acc"    ,";|t|_{eXBE}(MC|Reco.) [(GeV/#it{c}^{2})^{2}]", 40, 0., 2.);
  TH1D* h_teXBEAll_Reco    = new TH1D("texbeall_reco"   ,";|t|_{eXBE}(Reco.) [(GeV/#it{c}^{2})^{2}]"   , 40, 0., 2.);
  TH2D* h_teXBEAll_Resp    = new TH2D("texbeall_resp"   ,";|t|_{eXBE}(MC|Reco.) [(GeV/#it{c}^{2})^{2}];|t|_{eXBE}(Reco.) [(GeV/#it{c}^{2})^{2}]", 40, 0., 2., 40, 0., 2.);
  TH1D* h_teXBEAll_Pur     = new TH1D("texbeall_pur"    ,";|t|_{eXBE}(Reco.) [(GeV/#it{c}^{2})^{2}];#frac{MC|Reco.}{Reco.}", 40, 0., 2.);
  TH1D* h_teXBEAll_Mig     = new TH1D("texbeall_mig"    ,";|t|_{eXBE}(Reco.) [(GeV/#it{c}^{2})^{2}];#frac{MC#pm1|Reco.}{Reco.}", 40, 0., 2.);
  TH2D* h_dteXBEvteXBE_All = new TH2D("dtexbevtexbe_all",";|t|_{eXBE}(MC|Reco.) [(GeV/#it{c}^{2})^{2}];#Deltat_{eXBE} [(GeV/#it{c}^{2})^{2}]", 40, 0., 2., 40, -1., 1.);
  // t from eX method - All missing proton events
  TH1D* h_teXBEPMiss_Truth   = new TH1D("texbepmiss_truth"  ,";|t|_{eXBE}(MC) [(GeV/#it{c}^{2})^{2}]"      , 40, 0., 2.);
  TH1D* h_teXBEPMiss_Acc     = new TH1D("texbepmiss_acc"    ,";|t|_{eXBE}(MC|Reco.) [(GeV/#it{c}^{2})^{2}]", 40, 0., 2.);
  TH1D* h_teXBEPMiss_Reco    = new TH1D("texbepmiss_reco"   ,";|t|_{eXBE}(Reco.) [(GeV/#it{c}^{2})^{2}]"   , 40, 0., 2.);
  TH2D* h_teXBEPMiss_Resp    = new TH2D("texbepmiss_resp"   ,";|t|_{eXBE}(MC|Reco.) [(GeV/#it{c}^{2})^{2}];|t|_{eXBE}(Reco.) [(GeV/#it{c}^{2})^{2}]", 40, 0., 2., 40, 0., 2.);
  TH1D* h_teXBEPMiss_Pur     = new TH1D("texbepmiss_pur"    ,";|t|_{eXBE}(Reco.) [(GeV/#it{c}^{2})^{2}];#frac{MC|Reco.}{Reco.}", 40, 0., 2.);
  TH1D* h_teXBEPMiss_Mig     = new TH1D("texbepmiss_mig"    ,";|t|_{eXBE}(Reco.) [(GeV/#it{c}^{2})^{2}];#frac{MC#pm1|Reco.}{Reco.}", 40, 0., 2.);
  TH2D* h_dteXBEvteXBE_PMiss = new TH2D("dtexbevtexbe_pmiss",";|t|_{eXBE}(MC|Reco.) [(GeV/#it{c}^{2})^{2}];#Deltat_{eXBE} [(GeV/#it{c}^{2})^{2}]", 40, 0., 2., 40, -1., 1.);
  // t from eX method - Only if proton detected
  TH1D* h_teXBEPRec_Truth   = new TH1D("texbeprec_truth"  ,";|t|_{eXBE}(MC) [(GeV/#it{c}^{2})^{2}]"           , 40, 0., 2.);
  TH1D* h_teXBEPRec_Acc     = new TH1D("texbeprec_acc"    ,";|t|_{eXBE}(MC|Reco.) [(GeV/#it{c}^{2})^{2}]", 40, 0., 2.);
  TH1D* h_teXBEPRec_Reco    = new TH1D("texbeprec_reco"   ,";|t|_{eXBE}(Reco.) [(GeV/#it{c}^{2})^{2}]"   , 40, 0., 2.);
  TH2D* h_teXBEPRec_Resp    = new TH2D("texbeprec_resp"   ,";|t|_{eXBE}(MC|Reco.) [(GeV/#it{c}^{2})^{2}];|t|_{eXBE}(Reco.) [(GeV/#it{c}^{2})^{2}]", 40, 0., 2., 40, 0., 2.);
  TH1D* h_teXBEPRec_Pur     = new TH1D("texbeprec_pur"    ,";|t|_{eXBE}(Reco.) [(GeV/#it{c}^{2})^{2}];#frac{MC|Reco.}{Reco.}", 40, 0., 2.);
  TH1D* h_teXBEPRec_Mig     = new TH1D("texbeprec_mig"    ,";|t|_{eXBE}(Reco.) [(GeV/#it{c}^{2})^{2}];#frac{MC#pm1|Reco.}{Reco.}", 40, 0., 2.);
  TH2D* h_dteXBEvteXBE_PRec = new TH2D("dtexbevtexbe_prec",";|t|_{eXBE}(MC|Reco.) [(GeV/#it{c}^{2})^{2}];#Deltat_{eXBE} [(GeV/#it{c}^{2})^{2}]", 40, 0., 2., 40, -1., 1.);
  ...
  TH1D* h_E_p_Truth  = new TH1D("E_p_truth" ,";E_{p'}(MC) [GeV]"           , (Int_t)1.5*fPBeam_p, 0., 1.5*fPBeam_p);
  TH1D* h_E_p_B0Acc  = new TH1D("E_p_b0acc" ,";E_{p'}(MC|Reco. - B0) [GeV]", (Int_t)1.5*fPBeam_p, 0., 1.5*fPBeam_p);
  TH1D* h_E_p_RPAcc  = new TH1D("E_p_rpacc" ,";E_{p'}(MC|Reco. - RP) [GeV]", (Int_t)1.5*fPBeam_p, 0., 1.5*fPBeam_p);
  TH1D* h_E_p_B0Reco = new TH1D("E_p_b0reco",";E_{p'}(Reco. - B0) [GeV]"   , (Int_t)1.5*fPBeam_p, 0., 1.5*fPBeam_p);
  TH1D* h_E_p_RPReco = new TH1D("E_p_rpreco",";E_{p'}(Reco. - RP) [GeV]"   , (Int_t)1.5*fPBeam_p, 0., 1.5*fPBeam_p);
  TH2D* h_E_p_B0Resp = new TH2D("E_p_b0resp",";E_{p'}(MC|Reco. - B0) [GeV];E_{p'}(Reco. - B0) [GeV]", (Int_t)1.5*fPBeam_p, 0., 1.5*fPBeam_p, (Int_t)1.5*fPBeam_p, 0., 1.5*fPBeam_p);
  TH2D* h_E_p_RPResp = new TH2D("E_p_rpresp",";E_{p'}(MC|Reco. - RP) [GeV];E_{p'}(Reco. - RP) [GeV]", (Int_t)1.5*fPBeam_p, 0., 1.5*fPBeam_p, (Int_t)1.5*fPBeam_p, 0., 1.5*fPBeam_p);
  TH1D* h_E_p_B0Pur  = new TH1D("E_p_b0pur" ,";E_{p'}(Reco. - B0) [GeV];#frac{MC|Reco.}{Reco.}", (Int_t)1.5*fPBeam_p, 0., 1.5*fPBeam_p);
  TH1D* h_E_p_RPPur  = new TH1D("E_p_rppur" ,";E_{p'}(Reco. - RP) [GeV];#frac{MC|Reco.}{Reco.}", (Int_t)1.5*fPBeam_p, 0., 1.5*fPBeam_p);
  TH1D* h_E_p_B0Mig  = new TH1D("E_p_b0mig" ,";E_{p'}(Reco. - B0) [GeV];#frac{MC#pm1|Reco.}{Reco.}", (Int_t)1.5*fPBeam_p, 0., 1.5*fPBeam_p);
  TH1D* h_E_p_RPMig  = new TH1D("E_p_rpmig" ,";E_{p'}(Reco. - RP) [GeV];#frac{MC#pm1|Reco.}{Reco.}", (Int_t)1.5*fPBeam_p, 0., 1.5*fPBeam_p);
  ...
  TH1D* h_E_e_Truth = new TH1D("E_e_truth",";E_{e'}(MC) [GeV]"      , (Int_t)2*fPBeam_e, 0.0, 2*fPBeam_e);
  TH1D* h_E_e_Acc   = new TH1D("E_e_acc"  ,";E_{e'}(MC|Reco.) [GeV]", (Int_t)2*fPBeam_e, 0.0, 2*fPBeam_e);
  TH1D* h_E_e_Reco  = new TH1D("E_e_reco" ,";E_{e'}(Reco.) [GeV]"   , (Int_t)2*fPBeam_e, 0.0, 2*fPBeam_e);
  TH2D* h_E_e_Resp  = new TH2D("E_e_resp" ,";E_{e'}(MC|Reco.) [GeV];E_{e'}(Reco.) [GeV]", (Int_t)2*fPBeam_e, 0.0, 2*fPBeam_e, (Int_t)2*fPBeam_e, 0.0, 2*fPBeam_e);
  TH1D* h_E_e_Pur   = new TH1D("E_e_pur"  ,";E_{e'}(Reco.) [GeV];#frac{MC|Reco.}{Reco.}", (Int_t)2*fPBeam_e, 0.0, 2*fPBeam_e);
  TH1D* h_E_e_Mig   = new TH1D("E_e_mig"  ,";E_{e'}(Reco.) [GeV];#frac{MC#pm1|Reco.}{Reco.}", (Int_t)2*fPBeam_e, 0.0, 2*fPBeam_e);
  ...
  while(getline(fileListStream,fileName)){
	...
	h_EOverp_e_Truth->Fill(scate4_gen[0].E()/scate4_gen[0].P());
      ...
      // MC Acceptance and Reconstructed
	...
	h_Q2_Reco->Fill(Q2_rec);
	h_Q2_Acc->Fill(Q2_acc);
	h_xB_Reco->Fill(x_rec);
	h_xB_Acc->Fill(x_acc);
	h_y_Reco->Fill(y_rec);
	h_y_Acc->Fill(y_acc);
	...
	// Filling - response and difference
	...
	// Filling - purities and bin migration
	// Purities: Fill bin if reco matches MC
	// Bin migration: Fill if reco is 1 bin off MC
	...
	// Filling - purity and bin migration
	...
	h_E_p_Truth->Fill(scatp4_gen[0].E());
      ...
      // Reconstructed - B0 (accepted only works for B0)
	...
	if(TMath::Abs(h_E_p_B0Acc->FindBin(scatp4_aso[0].E()) - h_E_p_B0Reco->FindBin(scatp4_rec[0].E())) == 1) h_E_p_B0Mig->Fill(scatp4_rec[0].E());
      ...
      // Reconstructed - RP (assume raw generated MC as associated)
	...
	if(TMath::Abs(h_t_RPAcc->FindBin(t_acc) - h_t_RPReco->FindBin(t_rec)) == 1) h_t_RPMig->Fill(t_rec);
      ...
      // Event variables - t (eXBE method) fMass_proton
      // MC
      if(applyCuts_Electron(beame4, scate4_gen)
	 && applyCuts_Photon(scatg4_gen)
	 //&& (TMath::Abs(calcPMiss_2Body(beame4, beamp4, scate4_gen[0], scatg4_gen[0])-fPBeam_p) < 0.05*fPBeam_p)
	 ){
	double t_mc = calcT_MethodL(beame4,beamp4,scate4_gen[0],fMass_proton,scatg4_gen[0]);
	h_teXBEAll_Truth->Fill(t_mc);
	//h_teXBEAll_Truth->Fill(calcT_MethodL(beame4,beamp4,scate4_gen[0],fMass_proton,scatg4_gen[0]));
		
	if(scatp4_gen.size() == 0) h_teXBEPMiss_Truth->Fill(t_mc);
	if(scatp4_gen.size() == 1) h_teXBEPRec_Truth->Fill(t_mc);  
      }
      // Reconstructed and MC accepted
      if(applyCuts_Electron(beame4, scate4_rec)
	...
	// Distributions
       	h_teXBEAll_Acc->Fill(t_acc);
	h_teXBEAll_Reco->Fill(t_rec);

	// Response and difference
	h_teXBEAll_Resp->Fill(t_acc,t_rec);
	h_dteXBEvteXBE_All->Fill(t_acc,t_rec-t_acc);
	
	// Purity and bin migration
	if(h_teXBEAll_Acc->FindBin(t_acc) == h_teXBEAll_Reco->FindBin(t_rec)) h_teXBEAll_Pur->Fill(t_rec);
	if(TMath::Abs(h_teXBEAll_Acc->FindBin(t_acc) - h_teXBEAll_Reco->FindBin(t_rec)) == 1) h_teXBEAll_Mig->Fill(t_rec);

	// Now for missing proton case
	if( (scatp4_rec.size()+scatp4_rom.size()) == 0){
	  h_teXBEPMiss_Acc->Fill(t_acc);
	  h_teXBEPMiss_Reco->Fill(t_rec);
	  h_teXBEPMiss_Resp->Fill(t_acc,t_rec);
	  h_dteXBEvteXBE_PMiss->Fill(t_acc,t_rec-t_acc);

	  if(h_teXBEPMiss_Acc->FindBin(t_acc) == h_teXBEPMiss_Reco->FindBin(t_rec)) h_teXBEPMiss_Pur->Fill(t_rec);
	  if(TMath::Abs(h_teXBEPMiss_Acc->FindBin(t_acc) - h_teXBEPMiss_Reco->FindBin(t_rec)) == 1) h_teXBEPMiss_Mig->Fill(t_rec);
	}
	// ...and proton found
	if((applyCuts_Proton(scatp4_rec, "B0") && scatp4_rom.size() == 0) ||
	   (applyCuts_Proton(scatp4_rom, "RP") && scatp4_rec.size() == 0) ){
	  h_teXBEPRec_Acc->Fill(t_acc);
	  h_teXBEPRec_Reco->Fill(t_rec);
	  h_teXBEPRec_Resp->Fill(t_acc,t_rec);
	  h_dteXBEvteXBE_PRec->Fill(t_acc,t_rec-t_acc);
	  
	  if(h_teXBEPRec_Acc->FindBin(t_acc) == h_teXBEPRec_Reco->FindBin(t_rec)) h_teXBEPRec_Pur->Fill(t_rec);
	  if(TMath::Abs(h_teXBEPRec_Acc->FindBin(t_acc) - h_teXBEPRec_Reco->FindBin(t_rec)) == 1) h_teXBEPRec_Mig->Fill(t_rec);
	}
      }
	...
	if(applyCuts_Electron(beame4, scate4_gen)){
      ...
      // Reconstructed and MC accepted - for B0 only
	...
	h_HFSSigma_Acc->Fill(sigma_acc);
	h_HFSpT2_Reco->Fill(pT2_rec);
	h_HFSpT2_Acc->Fill(pT2_acc);
	...
	if(applyCuts_Electron(beame4, scate4_rec)){
	  ...
	  // Distributions
	  h_FullSigma_Acc->Fill(fullsig_acc);
      ...
      // Reconstructed and MC accepted - for RP only
  ...
  h_teXBEAll_Pur->Divide(h_teXBEAll_Reco);
  h_teXBEAll_Mig->Divide(h_teXBEAll_Reco);
  h_teXBEPMiss_Pur->Divide(h_teXBEPMiss_Reco);
  h_teXBEPMiss_Mig->Divide(h_teXBEPMiss_Reco);
  h_teXBEPRec_Pur->Divide(h_teXBEPRec_Reco);
  h_teXBEPRec_Mig->Divide(h_teXBEPRec_Reco);
  ...
  h_B0dtvt->Write();
  h_RPdtvt->Write();
  h_teXBEAll_Truth->Write();
  h_teXBEAll_Acc->Write();
  h_teXBEAll_Reco->Write();
  h_teXBEAll_Resp->Write();
  h_teXBEAll_Pur->Write();
  h_teXBEAll_Mig->Write();
  h_dteXBEvteXBE_All->Write();
  h_teXBEPMiss_Truth->Write();
  h_teXBEPMiss_Acc->Write();
  h_teXBEPMiss_Reco->Write();
  h_teXBEPMiss_Resp->Write();
  h_teXBEPMiss_Pur->Write();
  h_teXBEPMiss_Mig->Write();
  h_dteXBEvteXBE_PMiss->Write();
  h_teXBEPRec_Truth->Write();
  h_teXBEPRec_Acc->Write();
  h_teXBEPRec_Reco->Write();
  h_teXBEPRec_Resp->Write();
  h_teXBEPRec_Pur->Write();
  h_teXBEPRec_Mig->Write();
  h_dteXBEvteXBE_PRec->Write();
