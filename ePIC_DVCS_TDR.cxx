...
void ePIC_DVCS_TASK::doAnalysis(){
  ...
  TH2D* h_tResB0_2d = new TH2D("h_tresb0_2d",";|t|_{MC} [(GeV/#it{c})^{2}];#delta t [(GeV/#it{c})^{2}]", 20, 0., 2., 100, -5., 5.);
  TH2D* h_tResRP_2d = new TH2D("h_tresrp_2d",";|t|_{MC} [(GeV/#it{c})^{2}];#delta t [(GeV/#it{c})^{2}]", 20, 0., 2., 100, -5., 5.);
  TH2D* h_tResB0Pct_2d = new TH2D("h_tresb0pct_2d",";|t|_{MC} [(GeV/#it{c})^{2}];#Deltat/t_{MC}", 20, 0., 2., 200, -1., 1.);
  TH2D* h_tResRPPct_2d = new TH2D("h_tresrppct_2d",";|t|_{MC} [(GeV/#it{c})^{2}];#Deltat/t_{MC}", 20, 0., 2., 200, -1., 1.);
